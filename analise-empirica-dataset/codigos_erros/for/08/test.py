...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["5"]
        self.assertTrue(verificar_string("H = 0.783333", valores_entrada,self.file))

    def test_verificar_string_2(self):
        valores_entrada = ["15"]
        self.assertTrue(verificar_string("H = 0.725372", valores_entrada,self.file))

    def test_verificar_string_3(self):
        valores_entrada = ["3"]
        self.assertTrue(verificar_string("H = 0.833333", valores_entrada,self.file))
